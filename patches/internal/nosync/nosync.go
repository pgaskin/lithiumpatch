// Package nosync, if built with the nosync tag, disables the sync functionality
// since it isn't available unless a signing key is registered with Google APIs.
package nosync
